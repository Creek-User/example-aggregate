...
package io.github.creek.user.example.aggregate.api;
...
public final class ExampleAggregateAggregateDescriptor implements AggregateDescriptor {
    ...
    public ExampleAggregateAggregateDescriptor() {}
