...
package io.github.creek.user.example.aggregate.services;
...
import io.github.creek.user.example.aggregate.api.ExampleAggregateAggregateDescriptor;
import io.github.creek.user.example.aggregate.internal.TopicConfigBuilder;
...
public final class ExampleServiceDescriptor implements ServiceDescriptor {
    ...
    public String dockerImage() {
        return "ghcr.io/creekservice/example-aggregate-example-service";
    }
